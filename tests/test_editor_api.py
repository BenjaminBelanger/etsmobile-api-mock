...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/course/delete", {"courseId": "LOG999-99"}, "not found"),
        ("/course/restore", {"courseId": COURSE}, "not in trash"),
        (
            "/course/add",
        ...
        ("/evaluation/delete", {"courseId": COURSE, "index": 99}, "not found"),
        (
            "/evaluation/move",
            {"courseId": COURSE, "index": 0, "toIndex": 99},
            "not found",
        ),
        ("/grades/reset", {"courseId": COURSE}, "no stored grades"),
        ("/exam/reset", {"courseId": COURSE}, "no exam override"),
        ("/exam/set", {"courseId": COURSE}, "Nothing to update"),
